...
{
    public abstract class MovieWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MovieWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MovieWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MovieDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MovieDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MovieDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MovieDbContext, Task<T>> func)
        {
            T result;
